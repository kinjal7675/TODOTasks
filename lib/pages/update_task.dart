...
class _UpdateTaskState extends State<UpdateTask> {
            ...
            PopupMenuButton(
              ...
              itemBuilder: (BuildContext context) {
                return [
                  ...
                  }, Assets.svg.editIcon.svg(), locale.edit,
                      AppStrings.editTodoKey),
                  customPopupItem(() {
                    messageAlertDelete(locale.deleteTodo, locale.deleteMsg,
                        widget.todo, context, true);
                  }, Assets.svg.deleteIcon.svg(), locale.delete,
                      AppStrings.deleteTodoKey),
                  customPopupItem(() {
                    Share.share(
                        'Todo ${widget.todo.title} is for ${widget.todo.description}');
                  }, Assets.svg.shareIcon.svg(), locale.share,
                      AppStrings.shareTodoKey),
                ];
              },
            ),
          ],
  ...
  PopupMenuItem customPopupItem(
      onPressed, Widget icon, String title, ValueKey key) {
